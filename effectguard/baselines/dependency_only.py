...
from ..recovery import build_dependency_only_plan, execute_recovery_plan


def run_dependency_only(env: RunEnvironment) -> None:
    ...
    if reserve_status is ObservedStatus.UNKNOWN:
        ...
        if env.detect_contradiction_if_any():
            plan = build_dependency_only_plan(env)
